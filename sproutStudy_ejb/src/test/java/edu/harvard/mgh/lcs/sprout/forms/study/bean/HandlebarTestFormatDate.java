...
public class HandlebarTestFormatDate {
	...
	private void init() {
//		template.append("Submission Date: {{formatDate sprout.locale \"weekday\"}}");
		template.append("Submission Date: {{formatDate sprout.submissionDate \"short\"}}");
//		template.append("Submission Date: {{#formatDate sprout.submissionDate \"weekday\" }}{{/formatDate}}");
    }
	...
	private String json = "{\n" +
			...
			"    \"inboxId\": \"1108\",\n" +
			"    \"instanceId\": \"0FCACBF4-53B4-4337-8E8B-B10CBDED24AE\",\n" +
			"    \"currentStep\": \"step0\",\n" +
			"    \"currentInput\": \"\",\n" +
			"    \"validationStatus\": \"\",\n" +
			"    \"initStep\": \"\",\n" +
			"    \"initInput\": \"\",\n" +
			"    \"submissionDate\": \"1494009051154\",\n" +
//			"    \"submissionDate\": \"October 18\",\n" +
			"    \"expirationDate\": \"\",\n" +
			"    \"lockKey\": \"B5CE8D8A-236F-44E4-B89C-460A7405D239\",\n" +
			"    \"locale\": \"en\"\n" +
			"  },\n" +
			"  \"form\": {\n" +
			"    \"id\": \"1438\",\n" +
			...
			"    },\n" +
			"    \"conc_pockets\": {\n" +
			"      \"name\": \"Peter pockets food, meaning he/she leaves food in his/her mouth and does not swallow right away.\",\n" +
			"      \"value\": \"\"\n" +
			"    },\n" +
			"    \"conc_chew\": {\n" +
			"      \"name\": \"Peter does not chew his/her food well\",\n" +
			"      \"value\": \"\"\n" +
			"    },\n" +
			"    \"conc_toofast\": {\n" +
			"      \"name\": \"Peter eats too fast or puts too much food in his/her mouth at one time.\",\n" +
			"      \"value\": \"\"\n" +
			"    },\n" +
			"    \"conc_cough\": {\n" +
			"      \"name\": \"Peter coughs when he/she eats solid food\",\n" +
			"      \"value\": \"\"\n" +
			"    },\n" +
			"    \"conc_texture\": {\n" +
			"      \"name\": \"Peter is particular with the texture of certain foods\",\n" +
			"      \"value\": \"\"\n" +
			"    },\n" +
			"    \"comment_5\": \"\",\n" +
			"    \"sign_language\": {\n" +
