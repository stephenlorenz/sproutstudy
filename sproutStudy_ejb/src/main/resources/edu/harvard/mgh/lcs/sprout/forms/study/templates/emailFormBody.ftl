                ...
                <tr>
                    <td>
                        <h2 style="padding: 20px; font-weight: 400; background-color: #efefef; border-top: 5px solid #468847; -webkit-box-shadow: inset 0 3px 8px rgba(0, 0, 0, 0.125); -moz-box-shadow: inset 0 3px 8px rgba(0, 0, 0, 0.125); box-shadow: inset 0 3px 8px rgba(0, 0, 0, 0.125);">
                            ...
                            <span>A <strong>SproutStudy</strong> form has been delivered to you.</span>
                        </h2>
                    </td>
                </tr>
                <tr>
                    <td style="padding-left: 30px; padding-right: 30px; line-height: 24px;">
                        <p>Dear ${recipientFirstName},</p>

                        <p>${senderFullName} has sent you a form for your review along with this message:</p>
