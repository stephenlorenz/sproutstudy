...
//    });
        ...
        $scope.onSaveForm = function (form) {
            formManagerService.saveFormPublicationKey({
                id: form.id,
                publicationKey: form.publicationKey
            }, function (data) {
                if (data.value == 'true') {
//                alert("Form Publication Key was successfully saved.");
        ...
        $scope.onSaveNewForm = function () {
            formManagerService.saveForm({
                "formKey": $scope.form.formKey,
                "publicationKey": $scope.form.publicationKey,
                "name": $scope.form.name,
                "demographicInd": $scope.form.demographicInd,
                "cohort": $scope.cohort.cohortKey
            }, function (data) {
                if (data.value == 'true') {
                    formManagerService.setForm(null);
